...
user_pref("TC.Global.SidebarWidth", 475);
user_pref("TC.Global.ToolboxY", 105);
...
user_pref("app.update.lastUpdateTime.background-update-timer", 1515142303);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 0);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1515142063);
user_pref("app.update.lastUpdateTime.experiments-update-timer", 1515142423);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1515142183);
...
user_pref("browser.slowStartup.averageTime", 5427);
...
user_pref("datareporting.healthreport.nextDataSubmissionTime", "1515228342180");
...
user_pref("datareporting.policy.firstRunTime", "1515141942179");
user_pref("datareporting.sessions.current.activeTicks", 60);
user_pref("datareporting.sessions.current.firstPaint", 5131);
user_pref("datareporting.sessions.current.main", 369);
user_pref("datareporting.sessions.current.sessionRestored", 5469);
user_pref("datareporting.sessions.current.startTime", "1515141939694");
...
user_pref("toolkit.startup.last_success", 1515141940);
