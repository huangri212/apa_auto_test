...
Action()
{
	...
	truclient_step("19", "Evaluate JavaScript code LR.endTransaction('APA_P...e + ']', 'Auto')", "snapshot=Action_19.inf");
	...
	lr_start_transaction("APA_ProcessFlow_025_SelectFilter");
	truclient_step("24", "Click on Variant", "snapshot=Action_24.inf");
	lr_end_transaction("APA_ProcessFlow_025_SelectFilter",0);
	lr_start_transaction("APA_ProcessFlow_026_LoadFilter");
	truclient_step("25", "Click on Add Filter button", "snapshot=Action_25.inf");
	truclient_step("26", "Wait for Variant / 1 gridcell", "snapshot=Action_26.inf");
	truclient_step("27", "Wait 3 seconds", "snapshot=Action_27.inf");
	lr_end_transaction("APA_ProcessFlow_026_LoadFilter",0);
	truclient_step("28", "Click on Variant /", "snapshot=Action_28.inf");
	truclient_step("29", "Wait thinktime seconds", "snapshot=Action_29.inf");
	lr_start_transaction("APA_ProcessFlow_027_CheckFilterResult");
	truclient_step("30", "Click on Apply Filter", "snapshot=Action_30.inf");
	truclient_step("31", "Wait for Start Process", "snapshot=Action_31.inf");
